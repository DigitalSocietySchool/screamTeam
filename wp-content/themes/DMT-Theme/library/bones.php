...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
      ...
      // register main stylesheet
		...
		// Mixitup - jquery plugin for sorting and filter
		wp_register_script( 'jquery-mixitup', get_stylesheet_directory_uri() . '/library/js/libs/jquery.mixitup.min.js', array(), '', false );

		// jQuery-UI 
		wp_register_script( 'jquery-ui', get_stylesheet_directory_uri() . '/library/js/libs/jquery-ui.min.js', array(), '', false );
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
      ...
      wp_enqueue_style('screamdoc-stylesheet');
		...
		*/
		...
		//adding the script for the responsive menu
