...
get_header(); ?>
    ...
    <div id="bigcontainer" style="background-color: #F4F4F4;width:100%;height:100%;">
        ...
        <div id="innerContainer1" style="height: 50%;width: 100%;display:flex;flex-direction:row;padding-left: 3em;/* width: 50%; */background-color: #E0E0E0;">
                <img src="/wp-content/themes/DMT-Theme/library/images/landing1.png" style="width: 100%;padding-top: 0%;z-index: 2;position: absolute;height: 50%;"><div id="innerinner" style="height: 100%;width: 50%;display:flex;flex-direction:column;padding-top: 5em;float: left;z-index: 3;position: relative;">
        ...
        <div id="innerContainer2" style="height: 50%;width: 100%;display:flex;flex-direction:row;position: absolute;">
            <img src="/wp-content/themes/DMT-Theme/library/images/landing2.png" style="width: 100%;z-index: 1;position: absolute;height: 100%;/* margin-right: 45%; */">
