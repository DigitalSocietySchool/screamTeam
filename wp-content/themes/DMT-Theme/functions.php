...
function bones_register_sidebars() {
    ...
    register_sidebar(array(
		'id' => 'right_project_sidebar',
		'name' => __( 'Right project sidebar', 'bonestheme' ),
		'description' => __( 'Team information ', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
 ...
 */
function pagination_result_count( $wp_query = null ) {
    if ( ! $wp_query )
        global $wp_query;
...
function csv_importer_taxonomies() {
    register_taxonomy('category_rc', 'method-card', array(
        'hierarchical' => true,
        'label' => 'Category',
    ));
    register_taxonomy('sub-category', 'method-card', array(
        'hierarchical' => true,
        'label' => 'Sub-Category',
    ));
