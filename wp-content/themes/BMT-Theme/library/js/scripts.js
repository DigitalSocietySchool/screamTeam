...
jQuery(document).ready(function($) {
  ...
  var originalFilterArray = {
    ...
    '.stakeholders-money' : '.stakeholders-money',
...
/*
  $('#content').mixItUp({
  load: {
    filter: '.product-services, .market-customers, .stakeholders-money, .organization-culture, .sales-distribution'
  },
  controls: {
...
$(function(){
  ...
  */
  ...
  function deselectOthers(currentBtn) {
    ...
    //var srcdeactivated;
    /*
    srcdeactivated = $("#filter_market-customers_m").attr('src').replace('_activated', '_deactivated');
    $("#filter_market-customers_m").attr('src', srcdeactivated);
    srcdeactivated = $("#filter_stakeholders-money_m").attr('src').replace('_activated', '_deactivated');
    $("#filter_stakeholders-money_m").attr('src', srcdeactivated);
    srcdeactivated = $("#filter_product-services_m").attr('src').replace('_activated', '_deactivated');
    $("#filter_product-services_m").attr('src', srcdeactivated);
    srcdeactivated = $("#filter_organization-culture_m").attr('src').replace('_activated', '_deactivated');
    $("#filter_organization-culture_m").attr('src', srcdeactivated);
    srcdeactivated = $("#filter_sales-distribution_m").attr('src').replace('_activated', '_deactivated');
    $("#filter_sales-distribution_m").attr('src', srcdeactivated);
    //filterArray=[];
/*
    } else if($(this).hasClass('filter_stakeholders-money')) {
      alert("filter_stakeholders-money");
      $('#filter_stakeholders-money').toggleClass('active');
